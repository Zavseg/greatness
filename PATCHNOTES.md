...
- **Оновлення Hero-банера:** Повністю замінено фонове зображення з пасажирськими автомобілями сім'ї (`assets/family.png`) на преміальне фото вантажного автопарку (`assets/fleet_tk.jpg`), повністю приховуючи сім'ю та пасажирські машини.
