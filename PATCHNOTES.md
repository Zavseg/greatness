...
- **Активування автопарку ТК:** Повернуто розділ Автопарку (Fleet) до активного стану. Замість заглушки "в розробці" на першій сторінці відображаються 6 реальних вантажних автомобілів організації (Ceterpilort ST680, Fraitliner N2, Steelbilt 389).
- **Очищення даних автопарку:** З карток автомобілів прибрано номери у дужках (наприклад, `88AT`, `UN77` тощо), а також повністю приховано дані про парковку та об'єм бензину.
