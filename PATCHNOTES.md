...
- **Активування автопарку ТК:** Повернуто розділ Автопарку (Fleet) до активного стану. Замість заглушки "в розробці" відображаються 6 реальних вантажних автомобілів організації.
- **Очищення та оновлення даних автопарку (включаючи слайдер на Головній):** 
  - На сторінці "Автопарк" та у слайдері на головній сторінці виведено 6 індивідуальних вантажівок організації (**Ceterpilort ST680**, **Fraitliner N2**, **Steelbilt 389**) із використанням точного кропу з `assets/fleet_tk.jpg` для кожної.
  - З карток та слайдів прибрано номери у дужках (наприклад, `88AT`, `UN77` тощо).
  - Повністю виключено дані про паркування та об'єм палива (для слайдера залишено лише "Швидкість" та "Багажник").
