...
- **Оновлення Hero-банера:** Повністю замінено фонове зображення з пасажирськими автомобілями сім'ї (`assets/family.png`) на нове, спеціально згенероване художнє зображення в стилі GTA V (`assets/family_trucks.png`), на якому зображена команда ТК на фоні великих вантажівок та портових контейнерів на заході сонця.
